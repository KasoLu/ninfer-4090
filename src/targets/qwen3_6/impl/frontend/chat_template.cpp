...
std::string v224_tool_format_instructions(bool thinking) {
    ...
    out += "<tool_call>\n"
           ...
           "<item>element_1</item>\n"
           "<item>\n"
           "Any text, including code, is written exactly as it is.\n"
           "Quotes \" and brackets ] } [ { need no escaping.\n"
           "</item>\n"
           "</array>\n"
           "</item>\n"
           "<item>\n"
           ...
           "<item>element_2</item>\n"
           "<item>element_2</item>\n"
           "<item>a second element with the same shape</item>\n"
           "</array>\n"
           "</item>\n"
           "</array>\n"
           "</parameter>\n"
           "<parameter=example_parameter_4>\n"
           "<array>\n"
           "<item>\n"
    ...
    out += "- Function calls MUST follow the specified format: an inner <function=...></function> "
           ...
           "- A parameter whose declared type is an array MUST be written as an <array> block with "
           "one <item> element per array element (never as JSON brackets); an element that is "
           "itself an array contains its own <array> block.\n"
           "- A parameter whose declared type is an object MUST be written as one tag per "
           "property, named exactly like the property; a property that is itself an array or an "
           "object nests the same way.\n"
           "- Text inside a leaf tag is taken exactly as written: no JSON syntax and no escaping; "
           "it ends at its closing tag.\n";
    if (thinking) {
